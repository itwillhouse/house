...
<head>
	...
	window.onload = function() {
	    document.getElementById("address").addEventListener("click", function(){ // 주소입력 버튼을 클릭하면
	        //카카오 지도 발생
	        new daum.Postcode({
        ...
        <div class="col">
            ...
            <form class="pb-3" action="#" method="post">
    			...
    			<div class="form-group text-center">
    				...
    				<input type="text" class="form-control w-25 m-auto" id="address" placeholder="주소찾기" name="address" readonly>
    				<input type="text" class="form-control w-25 m-auto" id="addressDetail" placeholder="상세주소" name="addressDetail">
    			</div>
    			<div class="form-group text-center">
    			...
    			<div class="border w-25 m-auto">
    				...
    				<div class="form-check text-center pb-2">  				
        				<input type="checkbox" class="form-check-input" name="terms" value="age">만 14세 이상입니다
    				</div>
    				<div class="form-check text-center pb-2">
        				<input type="checkbox" class="form-check-input" name="terms" value="use">
        				<a href="#">이용약관</a>
    				</div>
    				<div class="form-check text-center pb-2">			
        				<input type="checkbox" class="form-check-input" name="terms" value="info">
        				<a href="#">개인정보수집 및 이용동의</a>
    				</div>
    				</div>
    			</div>
    			<div class="text-center pt-3">
    				<button type="submit" class="btn w-25" id="btn">회원가입하기</button>
    			</div>	  
          	</form>
          	<div class="text-center pb-1">
          		이미 아이디가 있으신가요? 
          		<a class="text-dark" href="../login/login.jsp"><u>로그인</u></a>
          	</div>
        </div>
    </div>
</div>
