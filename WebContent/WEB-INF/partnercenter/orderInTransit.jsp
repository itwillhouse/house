...
<head>
<meta charset="UTF-8">
<title>모두의집 - 파트너 센터 - 주문배송 - 배송중</title>
				...
				<td colspan="2">
					<p class="text-right">
						...
						<span style="font-size: 0.8em;">
							현재 배송중인 상태를 확인합니다.<br>
							선택배송완료를 눌러 배송완료 상태로 변경해주세요.
						</span>
					</p>
...
<div id="container">
	...
	<button class="btn btn-sm btn-primary" style="margin:20px;">
		선택배송완료
	</button>
	</p>
