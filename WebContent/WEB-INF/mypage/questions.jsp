...
<table style="width: 100%; margin: 0;">
	<tr>
		...
		<span onclick="location.href = 'view.jsp?requestIdx=${vo.requestIdx}'" style="cursor: pointer;">${vo.subject }</span>
		</td>
		<td rowspan="3" style="text-align: right;">
		<c:if test="${not empty vo.fileName }">
		<img alt="질문사진" src="${pageContext.request.contextPath}/requestImage/${vo.fileName}" style="width: 100px; height: 100px; object-fit:cover; border-radius: 5px;">
		</c:if>
