...
<div class="card" id="card" style="width: 15rem; height: 17rem; cursor: pointer;" onclick="location.href='knowhowDetail.do?idx=${vo.knowhowIdx }'">
  <img src="${vo.thumbnail }" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">
    		${vo.subject }<br>
