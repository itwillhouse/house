	...
	<%@ include file="WEB-INF/common/communityMenu.jspf" %>
		<div class="box1">
			<form action="product_inquiry_modify_ok.jsp?proinIdx=<%=proinIdx %>" method="post" enctype="multipart/form-data">	
				...
				<label for="fileName" class="fileName" style="border: none; background-color: deepskyblue; color: white; padding: 10px 45px; border-radius: 5px; font-weight: bold; font-size: 12px; margin-left: 50px; text-align: center;">파일 업로드</label>
				...
				<input type="submit" name="submit" value="제품문의 수정완료" id="submit">
			</form>
		</div>
